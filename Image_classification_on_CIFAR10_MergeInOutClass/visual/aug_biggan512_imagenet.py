...
parser.add_argument('--img_dir', default='/data/moy20/Imagenet/train/n02088364/n02088364_114.JPEG', type=str, metavar='ID', help='target image')
...
def main():
    ...
    checkpoint_dir = os.path.join(args.train_url, 'resnet50.pth')
