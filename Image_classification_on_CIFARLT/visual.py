...
if __name__ == "__main__":
    ...
    # file_dir = ["ISDA_test/cifar10_wideresnet-16-8_/no_1_lambda_0_0.5_standard-Aug__dropout_nostyle_seed=196_/checkpoint/checkpoint.pth.tar",
    # "ISDA_test/cifar10_wideresnet-16-8_/no_1_lambda_0_0.5_standard-Aug__dropout__addstyle__styletype=InOutclass__styleratio1=0.4_styleratio2=0.4__seed=196__layer=[0, 1]/checkpoint/checkpoint.pth.tar"]
    file_dir = ["ISDA_test/cifar10_resnet-110_/no_1_lambda_0_0.5_standard-Aug_nostyle_seed=400_/checkpoint/checkpoint.pth.tar",
    "ISDA_test/cifar10_resnet-110_/no_1_lambda_0_0.5_standard-Aug__addstyle__styletype=InOutclass__styleratio1=0.2_styleratio2=0.4__seed=169__layer=[0, 1]/checkpoint/checkpoint.pth.tar"]
    ...
    for i in range(len(embed2d_list)):
        ...
        for c in color:
            ...
            plt.scatter(e[:,0],e[:,1],s=2,label=1)
            plt.axis('off') 
            plt.savefig("resnet110-origin"+str(i)+".pdf")
        plt.close()
